...
function ImageComponets({item}) {
  ...
  return (
   ...
   <HoverOverlay>
      ...
      <Avatar
      src= {'https://i.pinimg.com/474x/e3/bf/45/e3bf454c13590ec9bb6c093a4c01f45a.jpg' || item?.author[0]} // Replace with REAL image URL
      style={{ 
        fontSize: "32px", 
        height: "32px", 
        width: "32px" // Must match height!
      }}
    >
    </Avatar>
    {""}
